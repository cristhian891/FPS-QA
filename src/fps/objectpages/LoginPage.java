...
public class LoginPage {
	...
	public static void crearcuenta(String name, String apellido, String apellidomadre, String correo, String password, String confirmpass){
		
		Init.driver.findElement(nombrefield).sendKeys(name);
		Init.driver.findElement(apellidopaternofield).sendKeys(apellido);
		Init.driver.findElement(apellidomaternofield).sendKeys(apellidomadre);
		Init.driver.findElement(correoelectronicofield).sendKeys(correo);
		Init.driver.findElement(contraseñafield).sendKeys(password);
		Init.driver.findElement(confirmarcontraseñafield).sendKeys(confirmpass);
		Init.driver.findElement(registrarbutton).click();
